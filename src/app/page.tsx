  ...
  return (
    <div className="container">
      ...
      <footer className="legal">
        <h3>免責聲明與隱私權說明</h3>
        <p>
          <strong>檢查結果僅供參考。</strong>
          本工具以自動化方式模擬一般使用者操作進行檢測，惟自動化檢測無法涵蓋所有情境，
          檢查結果不保證完整性與正確性，亦不構成任何形式之保證或專業建議。
          網站上線前仍建議進行人工複核，對於因依賴本檢查結果所生之任何直接或間接損失，本工具不負賠償責任。
        </p>
        <p>
          <strong>使用權限。</strong>
          請僅檢測您本人所有、或已取得所有權人授權之網站。
          使用者輸入網址進行檢測，即視為聲明其具備檢測該網站之正當權限，
          因未經授權檢測第三方網站所生之爭議與法律責任，由使用者自行承擔。
        </p>
        <p>
          <strong>隱私權與個人資料保護。</strong>
          本工具不要求註冊、不蒐集姓名、電子郵件等任何個人資料，符合《個人資料保護法》之規範。
          檢測過程中讀取之網頁內容、產生之截圖與報告，僅即時回傳予操作者本人瀏覽器顯示與下載，
          伺服器不留存任何檢測內容與檢測紀錄。被檢測網站之商標、圖文內容均屬原權利人所有。
        </p>
        <div className="credit">QA checker Design by Willie Lin</div>
      </footer>
    </div>
  );
}
